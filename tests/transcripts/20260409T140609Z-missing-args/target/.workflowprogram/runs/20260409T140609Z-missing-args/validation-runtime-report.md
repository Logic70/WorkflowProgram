...
- Run root: `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260409T140609Z-missing-args/target/.workflowprogram/runs/20260409T140609Z-missing-args`
- Target root: `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260409T140609Z-missing-args/target`
...
- `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260409T140609Z-missing-args/target/.workflowprogram/runs/20260409T140609Z-missing-args/workflow-spec.yaml`
...
- [PASS] `target_root_boundary_changes`: Changed target-root paths=['.workflowprogram/runs/20260409T140609Z-missing-args/events.jsonl', '.workflowprogram/runs/20260409T140609Z-missing-args/outputs/mock-runtime-host.log', '.workflowprogram/runs/20260409T140609Z-missing-args/outputs/target-claude-before.json', '.workflowprogram/runs/20260409T140609Z-missing-args/outputs/target-root-before.json', '.workflowprogram/runs/20260409T140609Z-missing-args/state.json', '.workflowprogram/runs/20260409T140609Z-missing-args/workflow-spec.yaml']; disallowed=['<none>'] (source: `runtime_contract.write_boundaries.target_root_allow`)
...
- [FAIL] `failure_recovery_target`: Observed next_stage_on_failure=provide the required request arguments; expected=design (source: `test_contract.flow.failure_recovery`)
