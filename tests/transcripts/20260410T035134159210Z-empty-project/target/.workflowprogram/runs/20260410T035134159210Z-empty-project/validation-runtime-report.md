...
fixture_host applied 4 managed workflow assets.
...
- [PASS] `evidence:outputs/managed-change-summary.md`: outputs/managed-change-summary.md exists in RUN_ROOT. (source: `runtime_smoke.evidence`)
