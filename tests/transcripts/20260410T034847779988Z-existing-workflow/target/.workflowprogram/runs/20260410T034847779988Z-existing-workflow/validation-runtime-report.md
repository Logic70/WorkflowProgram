...
- Run root: `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260410T034847779988Z-existing-workflow/target/.workflowprogram/runs/20260410T034847779988Z-existing-workflow`
- Target root: `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260410T034847779988Z-existing-workflow/target`
...
- `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260410T034847779988Z-existing-workflow/target/.workflowprogram/runs/20260410T034847779988Z-existing-workflow/workflow-spec.yaml`

## Entry Checks

- [PASS] `smoke_entry_invoked`: Observed smoke entry skill: workflowprogram-iterate (source: `smoke.invocation`)
- [PASS] `declared_main_entry`: Declared main_entry=workflowprogram-iterate; smoke entry=workflowprogram-iterate (source: `test_contract.entry.main_entry`)
...
- [PASS] `target_root_boundary_changes`: Changed target-root paths=['.workflowprogram/runs/20260410T034847779988Z-existing-workflow/events.jsonl', '.workflowprogram/runs/20260410T034847779988Z-existing-workflow/outputs/mock-runtime-host.log', '.workflowprogram/runs/20260410T034847779988Z-existing-workflow/outputs/progress/current-progress.json', '.workflowprogram/runs/20260410T034847779988Z-existing-workflow/outputs/progress/milestones.jsonl', '.workflowprogram/runs/20260410T034847779988Z-existing-workflow/outputs/progress/user-progress.md', '.workflowprogram/runs/20260410T034847779988Z-existing-workflow/outputs/stages/runner-summary.json', '.workflowprogram/runs/20260410T034847779988Z-existing-workflow/outputs/stages/s0-route.json', '.workflowprogram/runs/20260410T034847779988Z-existing-workflow/outputs/stages/s6-lessons-delta.md', '.workflowprogram/runs/20260410T034847779988Z-existing-workflow/outputs/target-claude-before.json', '.workflowprogram/runs/20260410T034847779988Z-existing-workflow/outputs/target-root-before.json', '.workflowprogram/runs/20260410T034847779988Z-existing-workflow/state.json', '.workflowprogram/runs/20260410T034847779988Z-existing-workflow/workflow-spec.yaml', 'validation-report.md']; disallowed=['<none>'] (source: `runtime_contract.write_boundaries.target_root_allow`)
...
- [PASS] `stage_history_available`: Observed stage_history=['lessons'] (source: `runtime-provider.stage_history`)
- [PASS] `required_stages_executed`: Observed stage_history=['lessons']; missing=none (source: `intent_flows.iterate.required_stage_slots`)
- [PASS] `unexpected_stages_absent`: Observed stage_history=['lessons']; allowed=['validate', 'lessons']; unexpected=['<none>'] (source: `intent_flows.iterate.required_stage_slots+intent_flows.iterate.optional_stage_slots`)
- [PASS] `stage_order_valid`: Observed stage_history=['lessons']; allowed_order=['validate', 'lessons'] (source: `intent_flows.iterate.required_stage_slots+intent_flows.iterate.optional_stage_slots`)
...
- [PASS] `skippable_stages_observed`: Present skippable stages=['<none>']; absent skippable stages=['validate'] (source: `intent_flows.iterate.optional_stage_slots`)
...
- [PASS] `route_evidence_matches_invocation`: Observed route entry_skill=workflowprogram-iterate; intent=iterate; expected entry_skill=workflowprogram-iterate; intent=iterate (source: `outputs/stages/s0-route.json`)
- [PASS] `runner_summary_matches_observed`: Observed runner-summary entry_skill=workflowprogram-iterate; status=PASS; expected entry_skill=workflowprogram-iterate; status=PASS (source: `outputs/stages/runner-summary.json`)
- [PASS] `s6_lessons_delta_exists`: s6-lessons-delta.md exists at /mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260410T034847779988Z-existing-workflow/target/.workflowprogram/runs/20260410T034847779988Z-existing-workflow/outputs/stages/s6-lessons-delta.md (source: `S6.outputs/stages/s6-lessons-delta.md`)
