...
- Run root: `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260410T034503836510Z-empty-project/target/.workflowprogram/runs/20260410T034503836510Z-empty-project`
- Target root: `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260410T034503836510Z-empty-project/target`
...
- `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260410T034503836510Z-empty-project/target/.workflowprogram/runs/20260410T034503836510Z-empty-project/workflow-spec.yaml`
...
- [PASS] `target_root_boundary_changes`: Changed target-root paths=['.claude/commands/example.md', '.claude/rules/constraints.md', '.claude/settings.json', '.workflowprogram/runs/20260410T034503836510Z-empty-project/events.jsonl', '.workflowprogram/runs/20260410T034503836510Z-empty-project/outputs/candidate/.claude/settings.json', '.workflowprogram/runs/20260410T034503836510Z-empty-project/outputs/managed-change-plan.json', '.workflowprogram/runs/20260410T034503836510Z-empty-project/outputs/managed-change-result.json', '.workflowprogram/runs/20260410T034503836510Z-empty-project/outputs/mock-runtime-host.log', '.workflowprogram/runs/20260410T034503836510Z-empty-project/outputs/progress/current-progress.json', '.workflowprogram/runs/20260410T034503836510Z-empty-project/outputs/progress/milestones.jsonl', '.workflowprogram/runs/20260410T034503836510Z-empty-project/outputs/progress/user-progress.md', '.workflowprogram/runs/20260410T034503836510Z-empty-project/outputs/stages/runner-summary.json', '.workflowprogram/runs/20260410T034503836510Z-empty-project/outputs/stages/s0-route.json', '.workflowprogram/runs/20260410T034503836510Z-empty-project/outputs/stages/s6-lessons-delta.md', '.workflowprogram/runs/20260410T034503836510Z-empty-project/outputs/target-claude-before.json', '.workflowprogram/runs/20260410T034503836510Z-empty-project/outputs/target-root-before.json', '.workflowprogram/runs/20260410T034503836510Z-empty-project/state.json', '.workflowprogram/runs/20260410T034503836510Z-empty-project/workflow-spec.md', '.workflowprogram/runs/20260410T034503836510Z-empty-project/workflow-spec.yaml']; disallowed=['<none>'] (source: `runtime_contract.write_boundaries.target_root_allow`)
...
- [PASS] `workflow_spec_draft_exists`: workflow-spec.md exists at /mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260410T034503836510Z-empty-project/target/.workflowprogram/runs/20260410T034503836510Z-empty-project/workflow-spec.md (source: `S1.workflow-spec.md`)
...
- [PASS] `s6_lessons_delta_exists`: s6-lessons-delta.md exists at /mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260410T034503836510Z-empty-project/target/.workflowprogram/runs/20260410T034503836510Z-empty-project/outputs/stages/s6-lessons-delta.md (source: `S6.outputs/stages/s6-lessons-delta.md`)
