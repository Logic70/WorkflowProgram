...
- Run root: `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260409T140708Z-broken-workflow/target/.workflowprogram/runs/20260409T140708Z-broken-workflow`
- Target root: `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260409T140708Z-broken-workflow/target`
...
- `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260409T140708Z-broken-workflow/target/.workflowprogram/runs/20260409T140708Z-broken-workflow/workflow-spec.yaml`

## Entry Checks

- [PASS] `smoke_entry_invoked`: Observed smoke entry skill: workflowprogram-validate (source: `smoke.invocation`)
- [INFO] `declared_main_entry`: Declared main_entry=example; smoke entry=workflowprogram-validate (source: `test_contract.entry.main_entry`)
...
- [PASS] `target_root_boundary_changes`: Changed target-root paths=['.claude/commands/example.md', '.claude/rules/constraints.md', '.claude/settings.json', '.workflowprogram/runs/20260409T140708Z-broken-workflow/events.jsonl', '.workflowprogram/runs/20260409T140708Z-broken-workflow/outputs/managed-change-plan.json', '.workflowprogram/runs/20260409T140708Z-broken-workflow/outputs/managed-change-result.json', '.workflowprogram/runs/20260409T140708Z-broken-workflow/outputs/mock-runtime-host.log', '.workflowprogram/runs/20260409T140708Z-broken-workflow/outputs/progress/current-progress.json', '.workflowprogram/runs/20260409T140708Z-broken-workflow/outputs/progress/milestones.jsonl', '.workflowprogram/runs/20260409T140708Z-broken-workflow/outputs/progress/user-progress.md', '.workflowprogram/runs/20260409T140708Z-broken-workflow/outputs/stages/runner-summary.json', '.workflowprogram/runs/20260409T140708Z-broken-workflow/outputs/stages/s0-route.json', '.workflowprogram/runs/20260409T140708Z-broken-workflow/outputs/target-claude-before.json', '.workflowprogram/runs/20260409T140708Z-broken-workflow/outputs/target-root-before.json', '.workflowprogram/runs/20260409T140708Z-broken-workflow/state.json', '.workflowprogram/runs/20260409T140708Z-broken-workflow/workflow-spec.yaml']; disallowed=['<none>'] (source: `runtime_contract.write_boundaries.target_root_allow`)
