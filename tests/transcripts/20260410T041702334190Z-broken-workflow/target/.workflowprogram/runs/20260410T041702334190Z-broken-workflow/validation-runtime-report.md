...
- Run root: `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260410T041702334190Z-broken-workflow/target/.workflowprogram/runs/20260410T041702334190Z-broken-workflow`
- Target root: `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260410T041702334190Z-broken-workflow/target`
...
- Final failure code: `EVIDENCE_FAILURE`
...
- `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260410T041702334190Z-broken-workflow/target/.workflowprogram/runs/20260410T041702334190Z-broken-workflow/workflow-spec.yaml`
...
- [PASS] `target_root_boundary_changes`: Changed target-root paths=['.workflowprogram/runs/20260410T041702334190Z-broken-workflow/events.jsonl', '.workflowprogram/runs/20260410T041702334190Z-broken-workflow/outputs/mock-runtime-host.log', '.workflowprogram/runs/20260410T041702334190Z-broken-workflow/outputs/progress/current-progress.json', '.workflowprogram/runs/20260410T041702334190Z-broken-workflow/outputs/progress/milestones.jsonl', '.workflowprogram/runs/20260410T041702334190Z-broken-workflow/outputs/progress/user-progress.md', '.workflowprogram/runs/20260410T041702334190Z-broken-workflow/outputs/stages/runner-summary.json', '.workflowprogram/runs/20260410T041702334190Z-broken-workflow/outputs/stages/s0-route.json', '.workflowprogram/runs/20260410T041702334190Z-broken-workflow/outputs/target-claude-before.json', '.workflowprogram/runs/20260410T041702334190Z-broken-workflow/outputs/target-root-before.json', '.workflowprogram/runs/20260410T041702334190Z-broken-workflow/state.json', '.workflowprogram/runs/20260410T041702334190Z-broken-workflow/workflow-spec.yaml', 'validation-report.md']; disallowed=['<none>'] (source: `runtime_contract.write_boundaries.target_root_allow`)
...
- [PASS] `required_stages_executed`: Observed stage_history=['validate']; missing=none (source: `intent_flows.validate.required_stage_slots`)
- [PASS] `unexpected_stages_absent`: Observed stage_history=['validate']; allowed=['validate', 'lessons']; unexpected=['<none>'] (source: `intent_flows.validate.required_stage_slots+intent_flows.validate.optional_stage_slots`)
- [PASS] `stage_order_valid`: Observed stage_history=['validate']; allowed_order=['validate', 'lessons'] (source: `intent_flows.validate.required_stage_slots+intent_flows.validate.optional_stage_slots`)
...
- [PASS] `skippable_stages_observed`: Present skippable stages=['<none>']; absent skippable stages=['lessons'] (source: `intent_flows.validate.optional_stage_slots`)
