...
- Run root: `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260409T140708Z-existing-workflow/target/.workflowprogram/runs/20260409T140708Z-existing-workflow`
- Target root: `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260409T140708Z-existing-workflow/target`
...
- `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260409T140708Z-existing-workflow/target/.workflowprogram/runs/20260409T140708Z-existing-workflow/workflow-spec.yaml`

## Entry Checks

- [PASS] `smoke_entry_invoked`: Observed smoke entry skill: workflowprogram-audit (source: `smoke.invocation`)
- [INFO] `declared_main_entry`: Declared main_entry=example; smoke entry=workflowprogram-audit (source: `test_contract.entry.main_entry`)
...
- [PASS] `target_root_boundary_changes`: Changed target-root paths=['.claude/commands/example.md', '.claude/rules/constraints.md', '.claude/settings.json', '.workflowprogram/runs/20260409T140708Z-existing-workflow/events.jsonl', '.workflowprogram/runs/20260409T140708Z-existing-workflow/outputs/managed-change-plan.json', '.workflowprogram/runs/20260409T140708Z-existing-workflow/outputs/managed-change-result.json', '.workflowprogram/runs/20260409T140708Z-existing-workflow/outputs/mock-runtime-host.log', '.workflowprogram/runs/20260409T140708Z-existing-workflow/outputs/progress/current-progress.json', '.workflowprogram/runs/20260409T140708Z-existing-workflow/outputs/progress/milestones.jsonl', '.workflowprogram/runs/20260409T140708Z-existing-workflow/outputs/progress/user-progress.md', '.workflowprogram/runs/20260409T140708Z-existing-workflow/outputs/stages/runner-summary.json', '.workflowprogram/runs/20260409T140708Z-existing-workflow/outputs/stages/s0-route.json', '.workflowprogram/runs/20260409T140708Z-existing-workflow/outputs/target-claude-before.json', '.workflowprogram/runs/20260409T140708Z-existing-workflow/outputs/target-root-before.json', '.workflowprogram/runs/20260409T140708Z-existing-workflow/state.json', '.workflowprogram/runs/20260409T140708Z-existing-workflow/workflow-spec.yaml']; disallowed=['<none>'] (source: `runtime_contract.write_boundaries.target_root_allow`)
