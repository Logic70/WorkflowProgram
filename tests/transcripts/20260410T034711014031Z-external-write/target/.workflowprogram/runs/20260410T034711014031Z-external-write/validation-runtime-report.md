...
- Run root: `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260410T034711014031Z-external-write/target/.workflowprogram/runs/20260410T034711014031Z-external-write`
- Target root: `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260410T034711014031Z-external-write/target`
...
Judge override: observed `PASS` / `none`, final `FAIL` / `S5_BOUNDARY_TARGET_ROOT_BOUNDARY_CHANGES`. Triggered by `boundary.target_root_boundary_changes`: Changed target-root paths=['.claude/commands/example.md', '.claude/rules/constraints.md', '.claude/settings.json', '.workflowprogram/runs/20260410T034711014031Z-external-write/events.jsonl', '.workflowprogram/runs/20260410T034711014031Z-external-write/outputs/candidate/.claude/settings.json', '.workflowprogram/runs/20260410T034711014031Z-external-write/outputs/managed-change-plan.json', '.workflowprogram/runs/20260410T034711014031Z-external-write/outputs/managed-change-result.json', '.workflowprogram/runs/20260410T034711014031Z-external-write/outputs/mock-runtime-host.log', '.workflowprogram/runs/20260410T034711014031Z-external-write/outputs/progress/current-progress.json', '.workflowprogram/runs/20260410T034711014031Z-external-write/outputs/progress/milestones.jsonl', '.workflowprogram/runs/20260410T034711014031Z-external-write/outputs/progress/user-progress.md', '.workflowprogram/runs/20260410T034711014031Z-external-write/outputs/stages/runner-summary.json', '.workflowprogram/runs/20260410T034711014031Z-external-write/outputs/stages/s0-route.json', '.workflowprogram/runs/20260410T034711014031Z-external-write/outputs/stages/s6-lessons-delta.md', '.workflowprogram/runs/20260410T034711014031Z-external-write/outputs/target-claude-before.json', '.workflowprogram/runs/20260410T034711014031Z-external-write/outputs/target-root-before.json', '.workflowprogram/runs/20260410T034711014031Z-external-write/state.json', '.workflowprogram/runs/20260410T034711014031Z-external-write/workflow-spec.md', '.workflowprogram/runs/20260410T034711014031Z-external-write/workflow-spec.yaml', 'rogue-output.txt']; disallowed=['rogue-output.txt']

## Spec Source

- `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260410T034711014031Z-external-write/target/.workflowprogram/runs/20260410T034711014031Z-external-write/workflow-spec.yaml`
...
- [FAIL] `target_root_boundary_changes`: Changed target-root paths=['.claude/commands/example.md', '.claude/rules/constraints.md', '.claude/settings.json', '.workflowprogram/runs/20260410T034711014031Z-external-write/events.jsonl', '.workflowprogram/runs/20260410T034711014031Z-external-write/outputs/candidate/.claude/settings.json', '.workflowprogram/runs/20260410T034711014031Z-external-write/outputs/managed-change-plan.json', '.workflowprogram/runs/20260410T034711014031Z-external-write/outputs/managed-change-result.json', '.workflowprogram/runs/20260410T034711014031Z-external-write/outputs/mock-runtime-host.log', '.workflowprogram/runs/20260410T034711014031Z-external-write/outputs/progress/current-progress.json', '.workflowprogram/runs/20260410T034711014031Z-external-write/outputs/progress/milestones.jsonl', '.workflowprogram/runs/20260410T034711014031Z-external-write/outputs/progress/user-progress.md', '.workflowprogram/runs/20260410T034711014031Z-external-write/outputs/stages/runner-summary.json', '.workflowprogram/runs/20260410T034711014031Z-external-write/outputs/stages/s0-route.json', '.workflowprogram/runs/20260410T034711014031Z-external-write/outputs/stages/s6-lessons-delta.md', '.workflowprogram/runs/20260410T034711014031Z-external-write/outputs/target-claude-before.json', '.workflowprogram/runs/20260410T034711014031Z-external-write/outputs/target-root-before.json', '.workflowprogram/runs/20260410T034711014031Z-external-write/state.json', '.workflowprogram/runs/20260410T034711014031Z-external-write/workflow-spec.md', '.workflowprogram/runs/20260410T034711014031Z-external-write/workflow-spec.yaml', 'rogue-output.txt']; disallowed=['rogue-output.txt'] (source: `runtime_contract.write_boundaries.target_root_allow`)
- [FAIL] `external_write_policy`: external_write_policy=deny; disallowed_changes=['rogue-output.txt'] (source: `test_contract.boundary.external_write_policy`)
...
- [PASS] `workflow_spec_draft_exists`: workflow-spec.md exists at /mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260410T034711014031Z-external-write/target/.workflowprogram/runs/20260410T034711014031Z-external-write/workflow-spec.md (source: `S1.workflow-spec.md`)
...
- [PASS] `s6_lessons_delta_exists`: s6-lessons-delta.md exists at /mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260410T034711014031Z-external-write/target/.workflowprogram/runs/20260410T034711014031Z-external-write/outputs/stages/s6-lessons-delta.md (source: `S6.outputs/stages/s6-lessons-delta.md`)
