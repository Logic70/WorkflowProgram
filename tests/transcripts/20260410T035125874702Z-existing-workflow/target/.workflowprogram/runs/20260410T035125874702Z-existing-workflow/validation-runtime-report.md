...
- Run root: `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260410T035125874702Z-existing-workflow/target/.workflowprogram/runs/20260410T035125874702Z-existing-workflow`
- Target root: `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260410T035125874702Z-existing-workflow/target`
...
- `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260410T035125874702Z-existing-workflow/target/.workflowprogram/runs/20260410T035125874702Z-existing-workflow/workflow-spec.yaml`
...
- [PASS] `target_root_boundary_changes`: Changed target-root paths=['.workflowprogram/runs/20260410T035125874702Z-existing-workflow/events.jsonl', '.workflowprogram/runs/20260410T035125874702Z-existing-workflow/outputs/mock-runtime-host.log', '.workflowprogram/runs/20260410T035125874702Z-existing-workflow/outputs/progress/current-progress.json', '.workflowprogram/runs/20260410T035125874702Z-existing-workflow/outputs/progress/milestones.jsonl', '.workflowprogram/runs/20260410T035125874702Z-existing-workflow/outputs/progress/user-progress.md', '.workflowprogram/runs/20260410T035125874702Z-existing-workflow/outputs/stages/runner-summary.json', '.workflowprogram/runs/20260410T035125874702Z-existing-workflow/outputs/stages/s0-route.json', '.workflowprogram/runs/20260410T035125874702Z-existing-workflow/outputs/stages/s6-lessons-delta.md', '.workflowprogram/runs/20260410T035125874702Z-existing-workflow/outputs/target-claude-before.json', '.workflowprogram/runs/20260410T035125874702Z-existing-workflow/outputs/target-root-before.json', '.workflowprogram/runs/20260410T035125874702Z-existing-workflow/state.json', '.workflowprogram/runs/20260410T035125874702Z-existing-workflow/workflow-spec.yaml', 'validation-report.md']; disallowed=['<none>'] (source: `runtime_contract.write_boundaries.target_root_allow`)
...
- [PASS] `s6_lessons_delta_exists`: s6-lessons-delta.md exists at /mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260410T035125874702Z-existing-workflow/target/.workflowprogram/runs/20260410T035125874702Z-existing-workflow/outputs/stages/s6-lessons-delta.md (source: `S6.outputs/stages/s6-lessons-delta.md`)
