...
- Run root: `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260409T141606Z-external-write/target/.workflowprogram/runs/20260409T141606Z-external-write`
- Target root: `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260409T141606Z-external-write/target`
...
Judge override: observed `PASS` / `none`, final `FAIL` / `S5_BOUNDARY_TARGET_ROOT_BOUNDARY_CHANGES`. Triggered by `boundary.target_root_boundary_changes`: Changed target-root paths=['.claude/commands/example.md', '.claude/rules/constraints.md', '.claude/settings.json', '.workflowprogram/runs/20260409T141606Z-external-write/events.jsonl', '.workflowprogram/runs/20260409T141606Z-external-write/outputs/candidate/.claude/settings.json', '.workflowprogram/runs/20260409T141606Z-external-write/outputs/managed-change-plan.json', '.workflowprogram/runs/20260409T141606Z-external-write/outputs/managed-change-result.json', '.workflowprogram/runs/20260409T141606Z-external-write/outputs/mock-runtime-host.log', '.workflowprogram/runs/20260409T141606Z-external-write/outputs/progress/current-progress.json', '.workflowprogram/runs/20260409T141606Z-external-write/outputs/progress/milestones.jsonl', '.workflowprogram/runs/20260409T141606Z-external-write/outputs/progress/user-progress.md', '.workflowprogram/runs/20260409T141606Z-external-write/outputs/stages/runner-summary.json', '.workflowprogram/runs/20260409T141606Z-external-write/outputs/stages/s0-route.json', '.workflowprogram/runs/20260409T141606Z-external-write/outputs/target-claude-before.json', '.workflowprogram/runs/20260409T141606Z-external-write/outputs/target-root-before.json', '.workflowprogram/runs/20260409T141606Z-external-write/state.json', '.workflowprogram/runs/20260409T141606Z-external-write/workflow-spec.yaml', 'rogue-output.txt']; disallowed=['rogue-output.txt']

## Spec Source

- `/mnt/d/Code/WorkflowProgram-CN/tests/transcripts/20260409T141606Z-external-write/target/.workflowprogram/runs/20260409T141606Z-external-write/workflow-spec.yaml`
